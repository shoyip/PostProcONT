...
python minibar/minibar.py -p 0.5 -T -F -P demuxed_ data/raw/indexes.txt data/interim/S1AvsAAPF_20June2025/reads.fasta
...
mv demuxed_in.fasta data/interim/S1AvsAAPF_20June2025/input.fasta
mv demuxed_out.fasta data/interim/S1AvsAAPF_20June2025/output.fasta
